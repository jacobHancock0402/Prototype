...
public class NoCollision : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D coll)
    {
        if(Collider != null)
        {
            ...
            if ((coll.gameObject.tag == "Head" || coll.gameObject.tag == "Player" || coll.gameObject.tag == "rArm" || coll.gameObject.tag == "lArm" || (coll.gameObject.tag == "lLeg" && gameObject.tag != "lFoot") || (coll.gameObject.tag == "rLeg" && gameObject.tag != "rFoot" ) || coll.gameObject.tag == "LlLeg" || coll.gameObject.tag == "LrLeg" || coll.gameObject.tag == "Head" || (coll.gameObject.tag == "Body" &&  gameObject.tag != "rLeg" && gameObject.tag != "lLeg") || (coll.gameObject.tag == "rFoot" && gameObject.tag != "rLeg" ) || (coll.gameObject.tag == "lFoot" && gameObject.tag != "lLeg" )) && (coll.gameObject.tag != gameObject.tag) )
            {    
                Physics2D.IgnoreCollision(Collider, coll.gameObject.GetComponent<Collider2D>());
